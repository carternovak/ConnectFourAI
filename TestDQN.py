...
if __name__ == '__main__':
    ...
    training_results = agent.train(50000)
    ...
    true_self_play_agent = true_self_play(ConnectXBoard(), 50, episodes_per_generation=5000, random_episodes=5000)
    ...
    torch.save(true_self_play_agent.policy_net.state_dict(), Path('long-self-play-policy.pt'))
    torch.save(true_self_play_agent.target_net.state_dict(), Path('long-self-play-target.pt'))
