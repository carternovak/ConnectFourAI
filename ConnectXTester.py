    ...
    def test(self, print_results = True):
        ...
        for game in range(self.num_games):
            ...
            if (print_results):
                ...
                if (winner == 1):
                    print(f'Player One ({self.player_one_name}) won Game {game+1}')
                if (winner == -1):
                    print(f'Player Two ({self.player_two_name}) won Game {game+1}')
        ...
        print(f'Reults from {self.num_games+1} Games')
